...
// Package resources contains resources stored in the Scaleway infra provider state.
package resources
...
import (
	...
	"github.com/siderolabs/omni-infra-provider-scaleway/api/specs"
	providermeta "github.com/siderolabs/omni-infra-provider-scaleway/internal/pkg/provider/meta"
)
...
// Machine describes Scaleway machine configuration.
