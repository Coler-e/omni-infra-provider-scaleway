...
const file_specs_proto_rawDesc = "" +
	"\n" +
	"\vspecs.proto\x12\bscwspecs\"\x81\x01\n" +
	"\vMachineSpec\x12\x1b\n" +
	"\tserver_id\x18\x01 \x01(\tR\bserverId\x12\x1c\n" +
	"\tschematic\x18\x02 \x01(\tR\tschematic\x12#\n" +
	"\rtalos_version\x18\x03 \x01(\tR\ftalosVersion\x12\x12\n" +
	"\x04zone\x18\x04 \x01(\tR\x04zoneB>Z<github.com/siderolabs/omni-infra-provider-scaleway/api/specsb\x06proto3"
...
var file_specs_proto_goTypes = []any{
	(*MachineSpec)(nil), // 0: scwspecs.MachineSpec
}
